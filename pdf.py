    ...
    try:
        ...
        if pdf_doc.page_count > 0:
            ...
            if pdf_doc.page_count > 1:
                # Add a slider to navigate pages for multi-page PDFs
                page_num = st.slider(
                ...
                # If there's only one page, no slider is needed
                page_num = 1
                st.info("This PDF has only one page.")
